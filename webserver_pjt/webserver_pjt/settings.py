"""
Django settings for webserver_pjt project.
...
ROOT_URLCONF = 'webserver_pjt.urls'
...
WSGI_APPLICATION = 'webserver_pjt.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'ns_test', 'static')
